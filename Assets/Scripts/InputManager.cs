...
public class InputManager : Singleton<InputManager>
{
    ...
    {
        //Debug.Log("Touch started , " + context.ReadValue<float>() + " , " + playerControls.Touch.PrimaryPosition.ReadValue<Vector2>());
    ...
    {
        //Debug.Log("Touch ended" + context.ReadValue<float>() + " , " + playerControls.Touch.PrimaryPosition.ReadValue<Vector2>());
        if (OnEndTouch != null)
        {
